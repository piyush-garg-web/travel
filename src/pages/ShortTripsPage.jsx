    ...
    <div className="min-h-screen bg-brand-ivory py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-left">
      ...
      <div className="bg-white rounded-3xl p-6 border border-brand-teal/5 shadow-premium mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="space-y-2 text-xs">
          <label className="font-bold text-brand-forest/70 uppercase tracking-wider block">Filter by Category</label>
        ...
        <div className="w-full md:w-72 space-y-2 text-xs">
          <div className="flex justify-between font-bold text-brand-forest/70 uppercase tracking-wider">
            <label>Travel Radius (from Delhi)</label>
            <span className="text-brand-orange">{maxDistance} km</span>
          </div>
          <input
            type="range"
            min="50"
              ...
              <div className="p-6 flex-1 flex flex-col justify-between gap-6 text-sm">
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] text-brand-teal font-extrabold uppercase bg-brand-mint px-2.5 py-0.5 rounded border border-brand-teal/5">
                      {st.category}
                    </span>
                  ...
                  <div className="space-y-1.5 pt-2 text-xs text-brand-forest/75">
                    <p className="font-bold text-brand-teal">Highlights Included:</p>
                ...
                <div className="flex items-center justify-between border-t border-brand-teal/10 pt-4 mt-2">
                  <div>
                    ...
                    <span className="text-lg font-black text-brand-teal">₹{st.price}</span>
      ...
      <div className="mt-12 bg-brand-mint/40 rounded-3xl p-6 border border-brand-teal/10 flex flex-col md:flex-row items-center gap-4 text-xs md:text-sm">
        ...
        <div>
          <h4 className="font-bold text-brand-teal text-base">Eco-Friendly Local Escapes</h4>
          <p className="text-brand-forest/70 mt-0.5 leading-relaxed">
