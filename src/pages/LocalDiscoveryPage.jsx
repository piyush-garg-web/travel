    ...
    <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-left relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="mb-10">
          ...
          <p className="text-brand-forest/65 mt-2 max-w-xl leading-relaxed text-sm">
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between gap-6 text-sm">
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="text-[10px] text-brand-gold font-bold uppercase tracking-wide flex items-center gap-0.5">
                          <MapPin className="w-3 h-3 text-brand-orange" /> {exp.location}
                        </span>
